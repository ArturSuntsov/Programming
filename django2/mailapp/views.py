    ...
    return JsonResponse(
        {
            "service": "mailapp-api",
            "endpoints": {
                "send_email": "POST /api/emails/send/",
                "list_emails": "GET /api/emails/?user_email=<email>&box=inbox|sent|archive|trash",
                "get_email": "GET /api/emails/<id>/?user_email=<email>",
                "move_email": "PATCH /api/emails/<id>/move/",
                "delete_email": "DELETE /api/emails/<id>/delete/?user_email=<email>",
            },
        }
    )
